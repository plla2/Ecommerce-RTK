      ...
      <div className='container'>
        <div className='product-content'>
          <div className='section-title'>
            <h3 className='text-uppercase fw-9 text-regal-blue ls-1'>대표 상품들</h3>
          </div>
              ...
              products.slice(1, 21).map(product => (
                <div className='product-item bg-white' key={product.id}
                  ...
                  <div className='product-item-img'>
                    <img src={product.images[1]} alt="상품 이미지" />
                  ...
                  <div className='product-item-body'>
                    ...
                    <div className='product-item-price text-regal-blue fw-7'>{formatPrice(product.price)}</div>
                  </div>
                </div>
              ))
            }
